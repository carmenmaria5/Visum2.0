...
public class VisumSqliteHelper extends SQLiteOpenHelper {
    ...
    private String sqlCreatePrendas = "CREATE TABLE IF NOT EXISTS prendas (idPrenda integer primary key,nombrePrenda VARCHAR(45), puntuacion INTEGER,color VARCHAR(45),descripcion VARCHAR(45),etiqueta VARCHAR(45), fotoPrenda BLOB)" ;
