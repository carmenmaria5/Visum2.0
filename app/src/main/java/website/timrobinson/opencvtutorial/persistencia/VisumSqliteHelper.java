...
public class VisumSqliteHelper extends SQLiteOpenHelper {
    ...
    private String sqlCreateConjuntos = "CREATE TABLE IF NOT EXISTS conjuntos (idConjunto integer primary key,idPrenda1 VARCHAR(45),idPrenda2 VARCHAR(45), puntuacion INTEGER,descripcion VARCHAR(45),etiqueta VARCHAR(45), combina VARCHAR(1),FOREIGN KEY(idPrenda1) REFERENCES prendas(idPrenda),FOREIGN KEY(idPrenda2) REFERENCES prendas(idPrenda))" ;
